...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "👍🏼") || (event.body.toLowerCase() == "👍")) {
     return api.sendMessage("সর এখান থেকে লাইকার দেস কেনো..!🐸🤣👍⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
     return api.sendMessage("এত হাই-হ্যালো করো কেনো সাহেবি বাবু..!🍆⛏️🐸🤣", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Rakib") || (event.body.toLowerCase() == "Rakib vai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ @ইৃঁন্টাৃঁরৃঁনেৃঁশৃঁনাৃঁলৃঁ কিৃঁউৃঁটৃঁ ছেলে  ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rakib.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=61575822064475\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0161133****", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:RAKIB ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রাকিব আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is RAKIB ッ❤️ তাকে সবাই রাকিব নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "Jannat") || (event.body.toLowerCase() == "Jannat ")) {
     return api.sendMessage("খবরদার কেউ এই নামে কেউ ডাকা দিবানা এটা আমার বস রাকিবের এর বান্ধবী'র এর আইডি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "nusrat") || (event.body.toLowerCase() == "nusrat")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রাকিবে'র এর বান্ধবীর এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "tun") || (event.body.toLowerCase() == "tun")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রাকিবে'র এর পরিতের জি এফ  এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Jan") || (event.body.toLowerCase() == "Jan")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রাকিব শুধু ডাকবে..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@ইৃঁন্টাৃঁরৃঁনেৃঁশৃঁনাৃঁলৃঁ কিৃঁউৃঁটৃঁ ছেৃঁলেৃঁ  ") || (event.body.toLowerCase() == "@ইৃঁন্টাৃঁরৃঁনেৃঁশৃঁনাৃঁলৃঁ কিৃঁউৃঁটৃঁ ছেৃঁলেৃঁ ")) {
     return api.sendMessage("🥰-রাকিব-🌺 আমার বস সাব্বিরের'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম-হুম তুমি রাতে রাকিবের বাসায় চুরি করতে গিয়েছিলা বলো হুম😾⛏️😷", threadID);
   };
